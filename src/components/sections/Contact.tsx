      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        ...
        >
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <button 
              type="submit" 
              className="w-full accent-gradient text-white font-bold py-5 rounded-2xl flex items-center justify-center gap-3 hover:shadow-[0_0_30px_rgba(139,92,246,0.3)] transition-all"
            >
